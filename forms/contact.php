<?php
  ...
  */
  ...
  $receiving_email_address = 'cativantepoder@gmail.com';
  ...
  $contact->smtp = array(
    'host' => 'gmail.com',
    'username' => 'cativantepoder',
    'password' => 'Inosuke$0512#&',
    'port' => '587'
  );
  ...
  // If the length check number is set and the provided message text is under the set length in the add_message() method call
